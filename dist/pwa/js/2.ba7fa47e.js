...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@quasar/app/lib/webpack/loader.auto-import-client.js?kebab!./node_modules/vue-loader/lib??vue-loader-options!./src/layouts/MainLayout.vue?vue&type=template&id=043bbe6f&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('q-layout',{attrs:{"view":"lHh Lpr lFf"}},[_c('q-header',{staticClass:"bg-primary text-grey-10",attrs:{"bordered":""}},[_c('q-toolbar',{staticClass:"constrain"},[_c('q-toolbar-title',{staticClass:"text-bold text-fredoka-one text-white"},[_vm._v("\n        Photo"),_c('span',{staticStyle:{"font-style":"italic"}},[_vm._v("Ahhhhh v"+_vm._s(_vm.version))])])],1)],1),_c('q-footer',{staticClass:"bg-white"},[[_c('transition',{attrs:{"appear":"","enter-active-class":"animated bounceIn","leave-active-class":"animated fadeOut"}},[(_vm.showAppInstallBanner)?_c('div',{staticClass:"banner-container bg-primary"},[_c('div',{staticClass:"constrain-banner"},[_c('q-banner',{staticClass:"bg-primary text-white",attrs:{"dense":"","inline-actions":""},scopedSlots:_vm._u([{key:"avatar",fn:function(){return [_c('q-avatar',{attrs:{"name":"signal_wifi_off","color":"primary","icon":"system_update","font-size":"22px"}})]},proxy:true},{key:"action",fn:function(){return [_c('q-btn',{staticClass:"q-px-sm",attrs:{"dense":"","flat":"","label":"Yes"},on:{"click":_vm.installApp}}),_c('q-btn',{staticClass:"q-px-sm",attrs:{"dense":"","flat":"","label":"Later"},on:{"click":function($event){_vm.showAppInstallBanner = false}}}),_c('q-btn',{staticClass:"q-px-sm",attrs:{"dense":"","flat":"","label":"Never"},on:{"click":_vm.neverShowAppInstallBanner}})]},proxy:true}],null,false,2734498194)},[_c('b',[_vm._v("Install PhotoAh?")])])],1)]):_vm._e()])],[_c('transition',{attrs:{"appear":"","enter-active-class":"animated bounceIn","leave-active-class":"animated fadeOut"}},[(this.$store.showAppUpdatedBanner)?_c('div',{staticClass:"banner-container bg-primary"},[_c('div',{staticClass:"constrain-banner"},[_c('q-banner',{staticClass:"bg-primary text-white",attrs:{"dense":"","inline-actions":""},scopedSlots:_vm._u([{key:"avatar",fn:function(){return [_c('q-avatar',{attrs:{"name":"signal_wifi_off","color":"primary","icon":"system_update","font-size":"22px"}})]},proxy:true},{key:"action",fn:function(){return [_c('q-btn',{staticClass:"q-px-sm",attrs:{"dense":"","flat":"","label":"Yes"},on:{"click":function($event){return _vm.updateApp(true)}}}),_c('q-btn',{staticClass:"q-px-sm",attrs:{"dense":"","flat":"","label":"No"},on:{"click":function($event){return _vm.updateApp(false)}}})]},proxy:true}],null,false,2216117024)},[_c('b',[_vm._v("PhotoAh has an update pending, update now?")])])],1)]):_vm._e()])],_c('q-tabs',{staticClass:"text-grey-10",attrs:{"active-color":"primary","indicator-color":"transparent"},model:{value:(_vm.tab),callback:function ($$v) {_vm.tab=$$v},expression:"tab"}},[_c('q-route-tab',{attrs:{"to":"/","name":"slideshow","icon":"panorama","label":"Slideshow","disable":_vm.$store.images.length === 0}}),_c('q-route-tab',{attrs:{"to":"/settings","name":"settings","icon":"settings","label":"Settings"}}),_c('q-route-tab',{attrs:{"to":"/help","name":"help","icon":"support","label":"Help"}})],1)],2),_c('q-page-container',{staticClass:"bg-grey-1"},[_c('router-view')],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/layouts/MainLayout.vue?vue&type=template&id=043bbe6f&
...
/* harmony default export */ var MainLayoutvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    updateApp(yes) {
      ...
      if (store["c" /* store */].registration && store["c" /* store */].registration.waiting) {
        store["c" /* store */].registration.waiting.postMessage({
          type: 'SKIP_WAITING'
        });
      }
  ...
  created() {
    ...
    console.log('process.env: ', "0.0.62");
  },
...
//# sourceMappingURL=2.ba7fa47e.js.map