...
/******/ 	return __webpack_require__(__webpack_require__.s = "aec2");
/******/ })
/************************************************************************/
/******/ ({
...
var workbox_broadcast_update_version = __webpack_require__("7156");
...
var workbox_cacheable_response_version = __webpack_require__("8cb0");
...
// CONCATENATED MODULE: ./src-pwa/custom-service-worker.js
/*
...
registerRoute(({
  url
}) => url.pathname.startsWith('/sockjs-node/'), new NetworkOnly_NetworkOnly()); // TODO add networkonly for album apis

registerRoute(({
  url
}) => url.host.startsWith('fonts.g'), new CacheFirst_CacheFirst({
  cacheName: 'google-fonts',
  plugins: [new ExpirationPlugin_ExpirationPlugin({
    maxEntries: 30
  }), new CacheableResponsePlugin_CacheableResponsePlugin({
    statuses: [0, 200]
  })]
}));
registerRoute(({
  url
}) => url.href.startsWith('http'), new StaleWhileRevalidate_StaleWhileRevalidate({
