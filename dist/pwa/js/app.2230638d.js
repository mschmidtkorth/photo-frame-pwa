...
/******/ 		return __webpack_require__.p + "js/" + ({}[chunkId]||chunkId) + "." + {"2":"ba7fa47e","3":"df5fc9d6","4":"c746ffad","5":"7f405dea"}[chunkId] + ".js"
/******/ 	}
/******/
...
/******/ 				var href = "css/" + ({}[chunkId]||chunkId) + "." + {"2":"f1a0ce61","3":"faf2249f","4":"4fa05074","5":"31d6cfe0"}[chunkId] + ".css";
...
Object(register_service_worker["a" /* register */])("/service-worker.js", {
  ...
  async ready(reg) {
    ...
    boot_store["c" /* store */].registration = reg; // try {
  ...
  /* registration */
  {
    console.log('PHSW:Service worker has been registered.'); // TODO add timeout to check for new updates
  },
  ...
  updated(reg) {
    ...
    boot_store["c" /* store */].registration = reg;
    boot_store["c" /* store */].showAppUpdatedBanner = true;
  },
...
function GAuth(store) {
  ...
  this.initClient = async function () {
    ...
    try {
      ...
      console.log('authorization error: ', e); // actions.setApikey('')
...
/******/ });
//# sourceMappingURL=app.2230638d.js.map